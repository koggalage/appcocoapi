...
{
    public partial class BeautyPro_COCOContext : DbContext
    {
        public BeautyPro_COCOContext()
        {
        }

        public BeautyPro_COCOContext(DbContextOptions<BeautyPro_COCOContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<TblCustomerGiftVoucher> TblCustomerGiftVoucher { get; set; }
        ...
        public virtual DbSet<TblCustomerSchedule> TblCustomerSchedule { get; set; }
        public virtual DbSet<TblCustomerScheduleTreatment> TblCustomerScheduleTreatment { get; set; }
        ...
        public virtual DbSet<TblMastCreditCardType> TblMastCreditCardType { get; set; }
        public virtual DbSet<TblMastDeduction> TblMastDeduction { get; set; }
        public virtual DbSet<TblMastDepartment> TblMastDepartment { get; set; }
        public virtual DbSet<TblMastDesignation> TblMastDesignation { get; set; }
        public virtual DbSet<TblMastDiscountType> TblMastDiscountType { get; set; }
        ...
        public virtual DbSet<TblMastTreatmentType> TblMastTreatmentType { get; set; }
        ...
        public virtual DbSet<Tbl_ConsentFormIniti> Tbl_ConsentFormIniti { get; set; }
        public virtual DbSet<Tbl_ConsentFormDaily> Tbl_ConsentFormDaily { get; set; }
        public virtual DbSet<Tbl_TreatmentDailyUpdate> Tbl_TreatmentDailyUpdate { get; set; }
        public virtual DbSet<Tbl_TreatmentDailyUpdatePhotos> Tbl_TreatmentDailyUpdatePhotos { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=.\\SQLExpress;Database=BeautyPro_COCO;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblCustomerGiftVoucher>(entity =>
            {
            ...
            modelBuilder.Entity<TblCustomerInvoiceHeader>(entity =>
            {
                ...
                entity.HasIndex(e => e.Cctid);

                entity.HasIndex(e => e.CustomerId);

                entity.HasIndex(e => e.CustomerScheduleTreatmentCstid);
                ...
                entity.Property(e => e.ProductDueAmount).HasColumnType("decimal(18, 2)");

                entity.Property(e => e.ProductSubTotalAmount).HasColumnType("decimal(18, 2)");

                entity.Property(e => e.ProductTaxAmount).HasColumnType("decimal(18, 2)");
                ...
                entity.Property(e => e.TreatmentDiscountAmount).HasColumnType("decimal(18, 2)");

                entity.Property(e => e.TreatmentDueAmount).HasColumnType("decimal(18, 2)");

                entity.Property(e => e.TreatmentSubTotalAmount).HasColumnType("decimal(18, 2)");

                entity.Property(e => e.TreatmentTaxAmount).HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity<TblCustomerInvoiceProducts>(entity =>
            {
                ...
                entity.Property(e => e.Cipid).HasColumnName("CIPId");
            ...
            modelBuilder.Entity<TblCustomerSchedule>(entity =>
            {
            ...
            modelBuilder.Entity<TblCustomerScheduleTreatment>(entity =>
            {
            ...
            modelBuilder.Entity<TblMastCreditCardType>(entity =>
            {
                entity.HasKey(e => e.Cctid);

                entity.ToTable("Tbl_Mast_CreditCardType");
            ...
            modelBuilder.Entity<TblMastDepartment>(entity =>
            {
            ...
            modelBuilder.Entity<TblMastDiscountType>(entity =>
            {
                entity.HasKey(e => e.Dtid);

                entity.ToTable("Tbl_Mast_DiscountType");
            ...
            modelBuilder.Entity<TblMastTreatmentType>(entity =>
            {
            ...
            modelBuilder.Entity<TblProduct>(entity =>
            {
                ...
                entity.HasIndex(e => e.ProductSellingPriceItemId);
                ...
                entity.Property(e => e.ProductSellingPriceItemId)
                    .HasMaxLength(4)
                    .IsUnicode(false);
                ...
                entity.HasOne(d => d.ProductSellingPriceItem)
                    .WithMany(p => p.TblProduct)
                    .HasForeignKey(d => d.ProductSellingPriceItemId);
            });
